...
<form id="request" name="form1" method="post" action="">
  <table width="441" border="1">
    ...
    <?php
	$sel="select * from tbl_complaint c inner join tbl_troop t on c.troop_id=t.troop_id inner join  tbl_complainttype p on c.comptype_id=p.comptype_id where c.troop_id='".$_SESSION["troopid"]."'";
	//echo $sel;
