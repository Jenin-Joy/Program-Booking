                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="ArtistWork.php">Add Works</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="ViewReplays.php">View Replay</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="Changepassword.php">Change Password</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="ConformBooking.php">Confirm Booking</a>
                              </li>
                           </ul>
                        </div>
                     </nav>
