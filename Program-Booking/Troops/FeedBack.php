...
if(isset($_POST["save"]))
{
	...
	$ins="insert into tbl_feedback(feedback_date,feback_details,troop_id) value('".date("Y-m-d")."','".$feedback."','".$troopid."')";
	mysql_query($ins);
}
...
<form id="request" name="form1" method="post" action="">
  <table width="1267">
      ...
      <textarea name="txtfeedback" id="txtfeedback" cols="80" rows="15" required="required" placeholder="Feed Backs"></textarea></td>
    </tr>
    <tr>
