                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style28">
                             <input type="text "runat="server" ForeColor="#33CC33" style="font-weight: 700"value="<?php echo "ProBooking";?>"/>
                    ...
                    <tr>
                        ...
                        <td class="auto-style26">
                            <span class="auto-style62">Rs.</span><input ytpe="text" runat="server" ForeColor="#33CC33" style="font-weight: 700" CssClass="auto-style62" value="<?php echo $_SESSION['Amt'];?>"/>
                            ...
                            <table class="auto-style1">
                                <tr>
                                    ...
                                    <td class="auto-style52" colspan="2">
                                        <input type="text" name="txtName" runat="server" Width="300px" value="<?php echo $data['troop_name'];?>"/>
                                    </td>
                                </tr>
			...
			$data['troop_email'];?>"/>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style56">
                                        <input type="text" name=="txtPhone" runat="server" Width="300px"value="<?php echo $data['troop_condact'];?>"/>
                                    </td>
                                    <td class="auto-style56">
                                    ...
                                    <td class="auto-style47" colspan="3">
                                        <table class="auto-style1">
                                            <tr>
                                                ...
                                                <td>
                                                    <img alt="" class="auto-style49" src="../Payment - Copy/Images/msc.gif" /></td>
                                                <td>
                                                    <img alt="" class="auto-style48" src="../Payment - Copy/Images/vbv.gif" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
...
include("../Payment - Copy/footer.php");
?>