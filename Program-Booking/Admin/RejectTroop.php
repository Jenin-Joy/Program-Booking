...
if($_GET["rejid"])
{
	$up="update tbl_troop set troop_status='2' where troop_id='".$_GET["rejid"]."'";
	mysql_query($up);
}
...
<form id="form1" name="form1" method="post" action="">
  <table width="1213" border="1">
    ...
    <?php 
	$sel="select * from tbl_troop t inner join tbl_place p on t.place_id=p.place_id  where troop_status=2";
