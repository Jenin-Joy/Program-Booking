                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              <li class="nav-item active">
                                 <a class="nav-link" href="../Guest/Template/index.html">Home</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="../Guest/NewArtists.php">Artist</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="../Guest/NewTroops.php">Troop</a>
                              </li>
                              <li class="nav-item">
