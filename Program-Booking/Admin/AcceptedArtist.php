...
if($_GET["accid"])
{
	$up="update tbl_artist set artist_status='1' where artist_id='".$_GET["accid"]."'";
	mysql_query($up);
}
?>
...
<title>Accepted Artist</title>
<?php include("HomePage.php")?>
</head>

<body>
<div id="tab" align="center" style="overflow-x:auto">
<h2>Accepted Artists</h2>
<form id="form1" name="form1" method="post" action="">
  <table width="1213" border="1">
    ...
    <?php 
	$sel="select * from tbl_artist a inner join tbl_place p on a.place_id=p.place_id where artist_status=1";
