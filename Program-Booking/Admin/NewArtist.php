...
<form id="form1" name="form1" method="post" action="">
  <table width="1213" border="1">
    ...
    <?php 
	$sel="select * from tbl_artist a inner join tbl_place p on a.place_id=p.place_id where artist_status=0";
    ...
    <tr>
      ...
      <td><a href="AcceptedArtist.php?accid=<?php echo $row["artist_id"] ?>">Accept</a>	<a href="RejectArtist.php?rejid=<?php echo $row["artist_id"] ?>">Reject</a></td>
    </tr>
    <?php
	}
	?>
