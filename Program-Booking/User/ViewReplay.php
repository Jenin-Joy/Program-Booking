...
<form id="request" name="form1" method="post" action="">
  <table width="441" border="1">
    ...
    <?php
	$sel="select * from tbl_complaint c inner join tbl_user u on c.user_id=u.user_id inner join  tbl_complainttype t on c.comptype_id=t.comptype_id where c.user_id='".$_SESSION["userid"]."'";
	//echo $sel;
    ...
    <tr>
      ...
      <td><a href="ViewReplay.php?compid=<?php echo $row["comp_id"] ?>">Delete</a></td>
    </tr>
    <?php 
	}
	?>
