...
<form id="form1" name="form1" method="post" action="">
  <table width="1213" border="1" >
    ...
    <?php 
	$sel="select * from tbl_troop t inner join tbl_place p on t.place_id=p.place_id where troop_status='0'";
    ...
    <tr>
      ...
      <td><a href="AcceptedTroop.php?accid=<?php echo $row["troop_id"] ?>">Accept</a>	<a href="RejectTroop.php?rejid=<?php echo $row["troop_id"] ?>">Reject</a></td>
    </tr>
    <?php
	}
	?>
