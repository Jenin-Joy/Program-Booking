    ...
    <table class="auto-style1">
       ...
       <?php
        ...
        <tr>
          ...
          <img alt="" class="auto-style19" src="Images/1391796960_payment_method_card_visa.png" />&nbsp;&nbsp; <input type="radio"  runat="server" value="Master Card" name="rdlcard"  Width="108px" CssClass="style5" 
        ...
        <tr>
          ...
          <td><label for="txtAcc"></label>
          <input type="text" name="txtamount" id="txtamount" readonly="readonly" value="<?php echo $_GET['Amt'];?>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
