                            ...
                            <table class="auto-style1">
                                <tr>
                                    ...
                                    <td class="auto-style52" colspan="2">
                                        <input type="text" name="txtName" runat="server" Width="300px" value="<?php echo $data['user_name'];?>"/>
                                    </td>
                                </tr>
			...
			$data['user_email'];?>"/>
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style56">
                                        <input type="text" name=="txtPhone" runat="server" Width="300px"value="<?php echo $data['user_condact'];?>"/>
                                    </td>
                                    <td class="auto-style56">
                                    ...
                                    <td class="auto-style47" colspan="3">
                                        <table class="auto-style1">
                                            <tr>
                                                ...
                                                <td>
                                                    <img alt="" class="auto-style49" src="../Payment1/Images/msc.gif" /></td>
                                                <td>
                                                    <img alt="" class="auto-style48" src="../Payment1/Images/vbv.gif" /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
