...
if(isset($_POST["save"]))
{
	...
	$complaints=$_POST["txtcomplaints"];
	$troop=$_SESSION['troopid'];
	$ins="insert into tbl_complaint(comp_date,comptype_id,comp_condent,troop_id) value('".date("Y-m-d")."','".$comptype."','".$complaints."','".$troop."')";
	//echo $ins;
	mysql_query($ins);
}
...
<form id="request" name="form1" method="post" action="">
  ...
  ?>
    ...
    <tr>
      ...
      <textarea name="txtcomplaints" id="txtcomplaints" cols="80" rows="15" required="required" placeholder="Compaints"></textarea></td>
    </tr>
    <tr>
