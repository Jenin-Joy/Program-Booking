               ...
               <div class="row d_flex">
                  <div class=" col-md-2 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                              <a href="index.html"><img src="Template/images/Asset3ldpi.png" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
                     ...
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="Package.php">Add your Package</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="ViewArtist.php">View Artist</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="ViewProfile.php">View Profile</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link" href="ViewReplays.php">View Replays</a>
                              </li>
                           </ul>
                        </div>
                     </nav>
                  ...
                  <div class="col-md-2 d_none">
                     <ul class="email text_align_right">
                        <li> <a href="../Guest/Login.php"> Log out </a></li>
